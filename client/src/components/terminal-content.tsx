          ...
          <div className="flex-1 overflow-y-auto mb-4 terminal-scroll" ref={terminalRef} style={{ maxHeight: 'calc(100vh - 250px)' }}>
            {history.length === 0 && (
              <div className="text-center py-4 sm:py-8">
                ...
                <p className="text-gray-400 text-xs sm:text-sm">Type a command and press Enter to start...</p>
              ...
              <div className="grid grid-cols-3 gap-1.5">
                {quickCommands.map((command) => (
                  <button
                    ...
                    className="terminal-gray border border-green-400 px-2 py-1.5 text-xs rounded hover:bg-green-400 hover:text-black transition-colors text-center"
                  >
                    {command}
                  </button>
                ))}
